...
> RESPONSE: The spending dataset has data for the years 1991-2014. Meanwhile the coverage dataset only has the years 2013-2016. Thus, we would only be able to use data from 2013-2014 as these are the only overlapping years between the two datasets.

```{r}
spending1314 <- spending %>%
  select(starts_with('2013'), starts_with('2014'))
...
```{r}
filter(spending1314, Location == 'United States' & 'District of Columbia')

filter(coverage1314, Location == 'United States' & 'District of Columbia')
```
