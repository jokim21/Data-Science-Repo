...
> ANSWER: BabyNarrow2 has significantly less rows compared to BabyNarrow. This is because the BabyNarrow2 dataset had filtered for names that have 10,000 for each gender while the original BabyNarrow dataset accounted for all names. 
