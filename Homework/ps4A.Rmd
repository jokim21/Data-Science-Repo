...
> ANSWER: There are 12 tables within the webpage. 
...
> ANSWER: Currently, Genzebe Dibaba holds the record with a time of 4:13.31 in 2016.
...
> ANSWER: Sifan Hassan is the quickest from both indoor and outdoor events with a time of 4:12.33 acheived in 2019.
...
women_outdoors <- women_outdoor %>%
  mutate(Type = "Outdoor")

women_indoors <- women_indoor %>%
  mutate(Type = "Indoor")

women <- bind_rows(women_indoors, women_outdoors) %>%
  arrange(Time)
